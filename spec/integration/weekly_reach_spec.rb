...
describe "weekly-visitors" do
  ...
  it "should return JSON data for weekly visitors" do
    start_at = last_sunday_of(Date.today << 24).to_datetime
    ...
    data.should have(79).items
    data.first[:start_at].should == "2011-03-06" # start_at.to_date
    data.first[:end_at].should == "2011-03-12" # (start_at+6).to_date
